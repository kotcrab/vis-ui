...
import com.kotcrab.vis.plugin.spriter.ui.VisSpriterComponentTable;
import com.kotcrab.vis.runtime.plugin.VisPlugin;

/** @author Kotcrab */
@VisPlugin
public class VisSpriterComponentTableProvider implements ComponentTableProvider {
	@Override
	public ComponentTable<? extends Component> provide (SceneModuleContainer sceneMC) {
		return new VisSpriterComponentTable(sceneMC);
	}
}
