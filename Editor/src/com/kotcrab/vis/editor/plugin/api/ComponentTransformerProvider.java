...
public interface ComponentTransformerProvider {
	Array<ComponentTransformer> getTransformers ();

	Array<ConditionalComponentTransformer> getConditonalTransformers ();

	IntArray getSupportedSourceProjectVersions ();

	IntArray getSupportedTargetProjectVersions ();
}
