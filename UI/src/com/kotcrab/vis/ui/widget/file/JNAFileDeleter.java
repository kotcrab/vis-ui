...
import com.kotcrab.vis.ui.widget.file.FileChooser.FileDeleter;
...
/**
 * Special implementation of {@link FileDeleter} that can be used if your project is using JNA library. When set
 * to file chooser using {@link FileChooser#setFileDeleter(FileDeleter)}, when user deletes file it will be moved
 ...
 * @author Kotcrab
 */
public final class JNAFileDeleter implements FileDeleter {
